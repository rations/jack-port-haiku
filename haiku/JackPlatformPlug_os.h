...
#ifndef __JackPlatformPlug_haiku__
#define __JackPlatformPlug_haiku__

#define jack_server_dir "/tmp"
#define jack_client_dir "/tmp"

// Phase 1 ships no audio backend yet; default to the portable dummy driver.
// This becomes the Media Kit driver ("haiku") once that backend lands.
